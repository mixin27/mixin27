...
export default function NewInvoiceForm() {
    ...
    const [items, setItems] = useState<InvoiceItem[]>([
        { id: uuidv7(), description: "", quantity: 1, rate: 0, amount: 0 },
    ])
    ...
    return (
        <>
            ...
            <div className="relative border-b border-border/70 pt-32 pb-20">
                <div className="pointer-events-none absolute -top-10 right-0 size-125 rounded-full bg-purple-500/8 blur-[120px]" aria-hidden="true" />
                <div className="mx-auto max-w-7xl px-6">
                    <div className="flex items-start justify-between">
                        <div>
                            <Link href="/tools/invoices" className="mb-8 flex items-center gap-2 font-mono text-[11px] tracking-widest text-purple-400 uppercase transition-colors hover:text-purple-300">
                                <ArrowLeft className="size-3" />
                                Back to Invoices
                            </Link>
                            <h1 className="mb-4 text-5xl font-bold tracking-tight">New Invoice</h1>
                            <p className="max-w-xl text-lg leading-relaxed text-muted-foreground">Create a new invoice for your client</p>
                        </div>
                    </div>
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="rounded-2xl border border-border bg-card/60 p-6 md:p-8 shadow-sm">
                                ...
                                <div className="flex items-center justify-between gap-4">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <input
                                            ...
                                            className="w-24 rounded-xl border border-border bg-background/80 px-4 py-3 text-sm text-foreground outline-none text-right focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/20"
                                            min="0"
                                            step="0.01"
                                        />
                                        <span className="font-medium">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label className="font-mono text-[11px] tracking-widest text-muted-foreground uppercase mb-2">Notes</label>
                                <textarea
                                    value={notes}
