        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex items-start justify-between">
            <div>
              ...
              <h1 className="mb-4 text-5xl font-bold tracking-tight">Edit Receipt</h1>
              <p className="max-w-xl text-lg leading-relaxed text-muted-foreground">Update receipt details</p>
            </div>
          </div>
        </div>
      </div>
