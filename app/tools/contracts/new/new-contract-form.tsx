        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex items-start justify-between">
            <div>
              ...
              <h1 className="mb-4 text-5xl font-bold tracking-tight">New Contract</h1>
              <p className="max-w-xl text-lg leading-relaxed text-muted-foreground">Create a new contract from template</p>
            </div>
          </div>
        </div>
      </div>
