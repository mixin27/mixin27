        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex items-start justify-between">
            <div>
              ...
              <h1 className="mb-4 text-5xl font-bold tracking-tight">Edit Contract</h1>
              <p className="max-w-xl text-lg leading-relaxed text-muted-foreground">Update contract details</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        <form onSubmit={handleSubmit} className="max-w-5xl mx-auto space-y-8">
          ...
          {(originalContract.businessSignature ||
            ...
            <div className="rounded-2xl border border-blue-200 bg-blue-50 dark:bg-blue-950 p-6">
