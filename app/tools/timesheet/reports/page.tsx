        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex items-start justify-between">
            <div>
              ...
              <h1 className="mb-4 text-5xl font-bold tracking-tight">Reports</h1>
              <p className="max-w-xl text-lg leading-relaxed text-muted-foreground">View and export your time reports</p>
            </div>
            <button
      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div ref={reportRef} className="bg-background">
          ...
          {(viewType === "week" || viewType === "month") && (
            <div className="flex items-center justify-between mb-6 p-4 rounded-2xl border border-border bg-card/60 shadow-sm print:hidden">
              <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className="rounded-2xl border border-border bg-card/60 shadow-sm p-6">
              <p className="mt-1 font-mono text-[11px] tracking-widest text-muted-foreground/80 uppercase mb-1">Total Hours</p>
            ...
            <div className="rounded-2xl border border-border bg-card/60 shadow-sm p-6">
              <p className="mt-1 font-mono text-[11px] tracking-widest text-muted-foreground/80 uppercase mb-1">
                Billable Hours
              </p>
              <p className="bg-linear-to-br from-purple-400 to-purple-600 bg-clip-text text-3xl font-bold text-transparent">
            ...
            <div className="space-y-6">
              {groupedData.map(([groupKey, groupEntries]) => {
                ...
                return (
                  <div
                    key={groupKey}
                    className="rounded-2xl border border-border bg-card/60 shadow-sm overflow-hidden"
                  >
