            ...
            <div className="flex flex-col xl:flex-row items-center gap-8">
              ...
              <div className="mb-8 xl:mb-0">
                <Social
                  ...
                  iconStyle="w-9 h-9 border border-accent rounded-full flex justify-center items-center text-accent hover:bg-accent hover:text-primary hover:transition-all duration-500"
                />
              </div>
            </div>
          </div>
