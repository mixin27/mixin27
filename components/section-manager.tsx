  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between mb-4">
          <h2 className="text-2xl font-bold tracking-tight">Section Order & Visibility</h2>
      </div>
      ...
      <div className="space-y-2">
        {sortedSections.map((section) => (
          <div
            ...
            className={`flex items-center gap-3 p-4 rounded-2xl border border-border bg-card/60 transition-all cursor-move shadow-sm ${
      ...
      <div className="rounded-2xl border border-border bg-card/60 p-4 text-sm text-muted-foreground shadow-sm">
