...
const experience = [
  {
    ...
    tasks: [
      'Developed multiple mobile applications for clients and personal learning.',
      'Key projects: Yoyo Chatt (chat app), Beads Math (math learning app), Maun News (news app), Myanmar Calendar (calendar app)',
    ],
  },
  {
    ...
    tasks: [
      ...
      'Converted Android and Xamarin projects to Flutter.',
      'Built reusable frameworks reducing development time by 20%.',
      'Successfully delivered three major projects in collaboration with cross-functional teams.',
    ],
  },
  {
    ...
    tasks: [
      'Assisted in developing Android applications using Java and Kotlin.',
      'Fixed bugs, improved UI/UX, and supported senior developers.',
      'Collaborated on testing and documentation.',
    ],
  },
  {
    ...
    tasks: [
      'Assisted in designing and developing web application using NodeJS, React and MySQL',
