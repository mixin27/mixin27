...
// GET /api/timesheet - Get all time entries
// GET /api/timesheet?id=xxx - Get single time entry
...
// POST /api/timesheet - Create or update time entry
...
// DELETE /api/timesheet?id=xxx - Delete time entry
