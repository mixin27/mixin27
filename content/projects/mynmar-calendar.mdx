...
date: "2025-10-25"
tech: ["Flutter", "BLoC", "GoRouter", "Drift", "Firebase"]
...
![Feature Graphic](/images/projects/myanmar-calendar/featured-graphic.png)
...
|------------|-------------|-----------|
| ![Home](/images/projects/myanmar-calendar/screenshots/01_home_month.png) | ![Day Details](/images/projects/myanmar-calendar/screenshots/02_home_day_details.png) | ![Year View](/images/projects/myanmar-calendar/screenshots/03_views_year.png) |

| Week View | Day View | Converter |
|-----------|----------|-----------|
| ![Week View](/images/projects/myanmar-calendar/screenshots/04_views_week.png) | ![Day View](/images/projects/myanmar-calendar/screenshots/05_views_day.png) | ![Converter](/images/projects/myanmar-calendar/screenshots/06_converter_convert.png) |

| Calculator | Arithmetic | Moon Phase |
|------------|------------|------------|
| ![Calculate](/images/projects/myanmar-calendar/screenshots/07_converter_calculate.png) | ![Arithmetic](/images/projects/myanmar-calendar/screenshots/08_converter_arithmetic.png) | ![Moon Phase](/images/projects/myanmar-calendar/screenshots/09_converter_moon_phase.png) |

| Events List | Event Form | Settings |
|-------------|------------|----------|
| ![Event Lists](/images/projects/myanmar-calendar/screenshots/10_events_list.png) | ![Event Form](/images/projects/myanmar-calendar/screenshots/11_events_form.png) | ![Settings](/images/projects/myanmar-calendar/screenshots/12_settings_overview.png) |

| Generation Preview | Generation Editor | Export Result |
|--------------------|-------------------|---------------|
| ![Generation Preview](/images/projects/myanmar-calendar/screenshots/13_generation_preview.png) | ![Generation Editor](/images/projects/myanmar-calendar/screenshots/14_generation_editor.png) | ![Export Result](/images/projects/myanmar-calendar/screenshots/15_generation_export_result.png) |

| Widget Settings |
|-----------------|
| ![Widget Settings](/images/projects/myanmar-calendar/screenshots/16_widget_settings_android.png) |
