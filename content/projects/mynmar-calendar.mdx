...
links:
    ...
    demo: "https://github.com/mixin27/mmcalendar/releases/latest"
...
|---------|---------|---------|
| Home Screen | <Image src="/images/projects/myanmar-calendar/month_view.jpg" alt="Home" width={200} height={150} /> | Landing page |
